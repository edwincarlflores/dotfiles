return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>fg", "<cmd>Telescope live_grep<cr>", { desc = "Find string in cwd (global search)" })
    ...
    keymap.set("n", "<leader>fd", "<cmd>Telescope resume<cr>", { desc = "Resume with the last search" })
  end,
}
